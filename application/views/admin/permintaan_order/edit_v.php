        ...
        <div class="col-md-6">
          <div class="form-group"> 
           ...
           <div class="form-group">
            ...
            <input class="form-control" value="<?php echo $id_transaksi; ?>" autocomplete="off" required readonly>
             <input type="hidden" id="sales" name="sales" value="<?php echo $sales?>">  
   
          </div>
           <div class="form-group row">
              <div class="col-md-6"> 
            <label for="">ID PICKUP</label>
     <input class="form-control" value="<?php echo $kode; ?>" id="id_transaksi" name="id_transaksi" autocomplete="off" readonly required></div>
         ...
         <div class="box-footer">
          <div class="row">
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 text-right">
              <button type="submit" id="konfirmasi" class="btn btn-primary">Proses</button>
