           ...
           <div class="form-group">
            ...
            <input class="form-control" value="<?php echo $pickup; ?>" id="pickup" name="pickup" autocomplete="off" required readonly>
             ...
             <div class="form-group row">
              <div class="col-md-6"> <label for="">NO SPB</label>
            <input class="form-control" value="<?php echo $nomor; ?>" id="nomor" name="nomor" autocomplete="off" required></div>
         ...
         <div class="box-footer">
          <div class="row">
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 text-right">
              <button type="submit" id="konfirmasi" class="btn btn-primary">Konfirmasi</button>
