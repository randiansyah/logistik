...
<td>
  <input type="text" class="form-control jumlah_packing" id-tr="<?php echo $i-1; ?>" name="jumlah_packing[]"  value="" autocomplete="off">
</td>

  <td><input type="text" class="harga_packing form-control harga" id-tr="<?php echo $i-1; ?>" name="harga_packing[]" id="harga_packing" value="" autocomplete="off"></td>

<td><input type="text" class="harga_asuransi form-control harga" id-tr="<?php echo $i-1; ?>" name="harga_asuransi[]" id="harga_asuransi" value="" autocomplete="off"></td>  
<td><input type="text" class="jumlah form-control" id-tr="<?php echo $i-1; ?>" name="jumlah[]" id="jumlah" value="" autocomplete="off"></td>  
<td>

  <input type="hidden" name="getOption[]" id-tr="<?php echo $i-1; ?>">
   <select class="form-control select2 optionnya" id="opsi_satuan"  id-tr="<?php echo $i-1; ?>"  name="opsi_satuan[]">
                  <option>Pilih</option>              
...
<td ><input type="text" id-tr="<?php echo $i-1; ?>" class="harga_satuan form-control harga" name="harga_satuan[]" autocomplete="off"></td>    
  <td><input type="text" id-tr="<?php echo $i-1; ?>"  class="total_harga_packing form-control harga" id="total_harga_packing" name="total_harga_packing[]">
 <input type="hidden" class="form-control " name="total_harga_packing_convert[]">
  </td>    
  <td><input type="text" id-tr="<?php echo $i-1; ?>"  class="total_harga_asuransi form-control harga" id="total_harga_asuransi" name="total_harga_asuransi[]" autocomplete="off" >
 <input type="hidden" class="total_harga_asuransi_convert form-control " name="total_harga_asuransi_convert[]">
  </td> 
  <td>
    <input type="text" id-tr="<?php echo $i-1; ?>" class="total_harga_satuan form-control harga" name="total_harga_satuan[]" autocomplete="off">
  ...
  <?php if($this->data['is_superadmin']){?> 
<td>
<a href="#" url="<?php echo base_url().$this->uri->segment(1)?>/destroyRincian/<?php echo $val->id ?>" id="spbDelete" class="delete">
      ...
      <div class="col-md-2" >
        <br>
         <label for="" >Sub Total Harga</label>
          <input  class="form-control harga" value="" id="total_harga" name="total_harga" autocomplete="off">
           </div>
         <div class="col-md-2">
       <br>
         <label for="">Pajak</label>
          <input class="form-control harga pajak" value="Rp. 0" id="pajak" name="pajak" autocomplete="off">
...
<div class="col-md-2">
         ...
         <label for="" >Total Harga Packing</label>
          <input class="form-control harga" value="" id="sum_harga_packing" name="sum_harga_packing" autocomplete="off">
           </div>
           <div class="col-md-2">
            <br>
         <label for="">Total Harga Asuransi</label>
          <input class="form-control harga" value="" id="sum_harga_asuransi" name="sum_harga_asuransi" autocomplete="off">
           </div>
           <div class="col-md-2">
            <br>
         <label for=""><b><center>Grand Total</center></b></label>
          <input class="form-control harga" value="" id="total_harga_global" name="total_harga_global" autocomplete="off">
