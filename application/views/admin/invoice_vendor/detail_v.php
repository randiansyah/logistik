...
<section class="content">
  <div class="box box-default color-palette-box">
   ...
   <a href="<?php echo base_url('Transaksi_vendor/pdf/'.$id_transaksi)?>" target="blank" id="pdf" class="btn btn-sm btn-success"><i class="fa fa-download"></i>&nbsp;Cetak Invoice</a>      
   </div> 
...
<td><input type="text" class="harga_coli form-control harga w-auto" id-tr="<?php echo $i-1; ?>" name="harga_coli[]"  value="<?php echo "Rp.".number_format($val->harga_satuan_coli, 0, ".", ".") ?>">
<input type="hidden" class="form-control" id-tr="<?php echo $i-1; ?>" name="total_harga_coli_convert[]">
</td>
<td><input type="text" class="harga_kg form-control harga w-auto" id-tr="<?php echo $i-1; ?>" name="harga_kg[]"  value="<?php echo "Rp.".number_format($val->harga_satuan_kg, 0, ".", ".") ?>">
<input type="hidden" class="form-control" id-tr="<?php echo $i-1; ?>" name="total_harga_kg_convert[]" value="">
</td>

  
  <td><input type="text" id-tr="<?php echo $i-1; ?>"  class="total_harga form-control harga w-auto" id="total_harga" name="total_harga[]"  value="<?php echo "Rp.".number_format($val->total_harga_satuan, 0, ".", ".") ?>">
...
<br>
 ...
 <div class="col-md-6">
       ...
       <label for="">Catatan</label>
        <textarea cols="3" rows="3" value="<?php echo $catatan ?>" class="form-control" id="catatan" name="catatan"><?php echo $catatan ?></textarea>            
